...
open(){
	...
	then
		...
		echo "-------------------------------------------------------------------------------------------------------------------------------------"
		echo -e "1.Automatically choose the appropriate application\n2.Gedit\n3.Vi Editor\n"
		read open_option					
		case $open_option in 
			"1")
				echo "-----------------------------------------------Opening in file in 3...2..1.--------------------------------------------------------"
				xdg-open $open_filename 
				log
				;;
			"2")
				echo "-----------------------------------------------Opening in file in 3...2..1.---------------------------------------------------------"
...
loop() {
	...
	do	
		...
		case $mainoption in
			 ...
			 * )  
			      echo "-------------------------------------------------------------------------------------------------------------------------------------"
		  	      echo "---------------------------------------------------YOU ARE PRESSING WRONG OPTION...TRY AGAIN-----------------------------------------" 	
		 	      echo "-------------------------------------------------------------------------------------------------------------------------------------"
				  loop;;	
		esac
